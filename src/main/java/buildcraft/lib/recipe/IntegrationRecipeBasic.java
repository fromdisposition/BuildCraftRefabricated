...
public class IntegrationRecipeBasic extends IntegrationRecipe {
    ...
    public IntegrationRecipeBasic(Identifier name, long requiredMicroJoules, IngredientStack target,
            List<IngredientStack> toIntegrate, @Nonnull ItemStack output) {
        super(name);
    ...
    protected boolean matches(@Nonnull ItemStack target, NonNullList<ItemStack> toIntegrate) {
        ...
        NonNullList<ItemStack> toIntegrateCopy = toIntegrate.stream()
