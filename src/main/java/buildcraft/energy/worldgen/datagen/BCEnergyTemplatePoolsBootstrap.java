...
final class BCEnergyTemplatePoolsBootstrap {
   ...
   static final ResourceKey<StructureTemplatePool> PATCH_START = ResourceKey.create(
      Registries.TEMPLATE_POOL, BCRegistries.id("buildcraftenergy", "oil_deposit_patch/start")
   );
   ...
   static void bootstrap(BootstrapContext<StructureTemplatePool> context) {
      ...
      context.register(
         ...
         new StructureTemplatePool(
            ...
            ImmutableList.of(
               ...
               Pair.of(StructurePoolElement.single("buildcraftenergy:oil_lake_patch"), OilStructureDefaults.WEIGHT_LAKE)
            ),
      ...
      context.register(
         ...
         new StructureTemplatePool(
            ...
            ImmutableList.of(
               Pair.of(StructurePoolElement.single("buildcraftenergy:oil_well_large"), OilStructureDefaults.WEIGHT_LARGE),
               Pair.of(StructurePoolElement.single("buildcraftenergy:oil_well_large_alt"), OilStructureDefaults.WEIGHT_LARGE / 2),
               Pair.of(StructurePoolElement.single("buildcraftenergy:oil_well_medium"), OilStructureDefaults.WEIGHT_MEDIUM),
               Pair.of(StructurePoolElement.single("buildcraftenergy:oil_lake_patch"), OilStructureDefaults.WEIGHT_LAKE)
            ),
            StructureTemplatePool.Projection.RIGID
