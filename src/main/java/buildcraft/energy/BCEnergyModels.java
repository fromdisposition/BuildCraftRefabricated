...
public class BCEnergyModels {
    ...
    static {
        ...
        ENGINE_STONE = new EngineModelCache(
            new ModelHolderVariable("buildcraftenergy:models/compat/engine_stone.json", fnCtx),
            ENGINE_PROGRESS, ENGINE_STAGE, ENGINE_FACING);
        ENGINE_IRON = new EngineModelCache(
            new ModelHolderVariable("buildcraftenergy:models/compat/engine_iron.json", fnCtx),
            ENGINE_PROGRESS, ENGINE_STAGE, ENGINE_FACING);
        ENGINE_FE = new EngineModelCache(
            new ModelHolderVariable("buildcraftenergy:models/compat/engine_rf.json", fnCtx),
            ENGINE_PROGRESS, ENGINE_STAGE, ENGINE_FACING);
        DYNAMO_MJ = new EngineModelCache(
            new ModelHolderVariable("buildcraftenergy:models/compat/engine_dynamo.json", fnCtx),
            ENGINE_PROGRESS, ENGINE_STAGE, ENGINE_FACING);
    }
