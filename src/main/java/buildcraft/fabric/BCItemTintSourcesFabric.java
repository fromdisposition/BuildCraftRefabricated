...
public final class BCItemTintSourcesFabric {
    ...
    public static final Identifier FLUID_SHARD_TINT_ID =
            Identifier.fromNamespaceAndPath("buildcraftcore", "fluid_shard_tint");
    public static final Identifier PIPE_COLOUR_TINT_ID =
            Identifier.fromNamespaceAndPath("buildcrafttransport", "pipe_colour");
    ...
    public static void registerInto(ExtraCodecs.LateBoundIdMapper<Identifier, MapCodec<? extends ItemTintSource>> mapper) {
        if (registered) {
            return;
        }
        try {
