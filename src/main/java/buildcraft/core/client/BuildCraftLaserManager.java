...
public class BuildCraftLaserManager {
    ...
    public static final LaserType POWER_LOW;
    public static final LaserType POWER_MED;
    public static final LaserType POWER_HIGH;
    public static final LaserType POWER_FULL;
