...
/**
 * Breaks a single block over time, draining MJ proportional to its hardness (replacement for the 1.7.10 tick-damage
 * model). Drops are inserted into the robot, with any overflow dropped into the world.
 */
