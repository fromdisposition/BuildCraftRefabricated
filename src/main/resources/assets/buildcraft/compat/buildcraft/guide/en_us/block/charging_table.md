<lore>
A workbench wired straight into a beam of focused light. Set an empty tool on it, aim a laser, and watch the battery needle climb.
</lore>
<no_lore>
The Charging Table is a laser-powered charger. It transfers MJ from adjacent lasers into any energy-capable item placed in its slot, so tools and gadgets that store power can be topped up without a dedicated engine hookup.
</no_lore>
