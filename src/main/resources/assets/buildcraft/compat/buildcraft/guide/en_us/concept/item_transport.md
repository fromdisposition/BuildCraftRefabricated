<lore>
A pipe network is the circulatory system of a base — items flow where you route them, sorted and split along the way.
</lore>
<no_lore>
...
The <link inline="buildcraft:pipe/iron_item"/> forces everything out a single face (set with a wrench) — a one-way valve. The <link inline="buildcraft:pipe/diamond_item"/> sorts by item: give each output side a filter and matching items take that exit. Paint goods with the <link inline="buildcraft:pipe/lapis_item"/> and route the colours with the <link inline="buildcraft:pipe/daizuli_item"/>.
<chapter name="Special"/>
The <link inline="buildcraft:pipe/obsidian_item"/> vacuums dropped items (and even mobs) out of the world; the <link inline="buildcraft:pipe/void_item"/> quietly destroys whatever enters it — perfect for dumping surplus cobblestone.
